...
"DescriptorTable(SRV(t0, space=2, numDescriptors=12), visibility=SHADER_VISIBILITY_PIXEL), " \
"StaticSampler(s0," \
...
#define DefaultPbrRsMvp             0
#define DefaultPbrRsMaterial        1
#define DefaultPbrRsLighting        2
#define DefaultPbrRsCamera          3
#define DefaultPbrRsPbrTextures     4
#define DefaultPbrRsSub             5
#define DefaultPbrRsFrameConstants  6
